...
namespace Treasury.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260727160538_AddHistoricalImportApprovalAndCommit")]
    partial class AddHistoricalImportApprovalAndCommit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Treasury.Domain.Entities.HistoricalTransactionImportBatch", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "Mode", "FileHash")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "Status", "UploadedAtUtc");
            ...
            modelBuilder.Entity("Treasury.Domain.Entities.HistoricalTransactionImportRow", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "BatchId", "RowNumber")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "LegalEntityId", "BusinessUnitId");

                    b.ToTable("HistoricalTransactionImportRows", t =>
                        {
                            t.HasCheckConstraint("CK_HistoricalImportRows_Currency", "\"Currency\" IS NULL OR char_length(\"Currency\") = 3");

                            t.HasCheckConstraint("CK_HistoricalImportRows_Direction", "\"Direction\" IS NULL OR \"Direction\" IN ('Credit','Debit')");
