...
namespace Treasury.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717124836_AddInvestmentEarlyRedemptionApprovals")]
    partial class AddInvestmentEarlyRedemptionApprovals
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("ApprovalPolicies", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ApprovalPolicies_OperationType", "\"OperationType\" IN ('InternalTransfer', 'CashPayment', 'TransactionReversal', 'InvestmentPlacement', 'InvestmentEarlyRedemption')");
                    ...
                    b.ToTable("AuditLogs", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_AuditLogs_EntityType", "\"EntityType\" IN ('User','Role','Account','AccountType','TransferRequest','PaymentRequest','ReversalRequest','ApprovalPolicy','ApprovalDecision','TreasuryTransaction','BankStatementImport','BankStatementLine','CashFlowForecastItem','FxRate','TreasuryAlert','InvestmentPlacement','InvestmentEarlyRedemptionRequest','System')");
                        });
                });
